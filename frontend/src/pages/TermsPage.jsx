        ...
        <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
            ...
            <main className="flex-grow max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
                ...
                <div className="prose prose-indigo text-gray-500">
                    <p>Welcome to ShopIt. By using our website, you agree to the following terms and conditions.</p>
                    <h3>1. Usage</h3>
                    ...
                    <p>All content on this site is the property of ShopIt and protected by copyright laws.</p>
                    <h3>4. Limitation of Liability</h3>
                    <p>ShopIt is not liable for any damages arising from the use of this site.</p>
                </div>
            </main>
            <Footer />
        </div>
